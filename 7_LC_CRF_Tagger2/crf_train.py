...
class CRF_POS_Tagger:
    ...
    def compute_log_forward_prune_L1(self, words):
        ...
        for i in range(1, len(words)):
            tag_to_forward = dict()
            # prune tags with regard to lexical features
    ...
    def regularize_with_L1(self, features, remove_zero_weight=False):
        # update L1 for the given features
    ...
    def compute_accuracy(self, test_path, num_test_samples=None):
        ...
        for words, tags in tqdm(self.test_samples):
            words = [" "] + words + [" "]
...
if __name__ == "__main__":
    ...
    # python crf_train.py ../Tiger/train.txt param-file_lr0.001_mu0.001_full
    ...
    print(
        f"Running the model with: num_epoch = {num_epoch}, lr = {lr}, mu = {mu}, prune_lex = {prune_lex}, "
        f"prune_forward = {prune_forward}, num_samples = {num_samples}, num_test = {num_test}")